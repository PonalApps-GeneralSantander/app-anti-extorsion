...
const SUSPICIOUS_CALLS: SuspiciousCall[] = [
  {
    ...
    time: '10:30 AM',
    riskLevel: 'high',
    description: 'Llamada que se identifica como banco solicitando datos personales y claves bancarias.'
  },
  {
    id: '2',
    ...
    time: '3:45 PM',
    riskLevel: 'medium',
    description: 'Supuesto familiar en problemas solicitando dinero para emergencia.'
  },
  {
    id: '3',
    ...
    time: '5:20 PM',
    riskLevel: 'high',
    description: 'Llamada amenazante haciendo referencia a negocios de la zona.'
  },
  {
    id: '4',
    ...
    time: '11:05 AM',
    riskLevel: 'low',
    description: 'Supuesta empresa de servicios públicos solicitando pago inmediato.'
  },
  {
    id: '5',
    ...
    <SafeAreaView style={styles.container} edges={['bottom']}>
      ...
      <View style={styles.contentContainer}>
        ...
        <View style={styles.alertIdentificationContainer}>
          ...
          <View style={styles.alertBox}>
            <View style={styles.alertIconContainer}>
              <FontAwesome5 name="shield-alt" size={28} color={Colors.primary} />
            </View>
            <View style={styles.alertTextContainer}>
              ...
              <Text style={styles.alertDescription}>
                Identificamos automáticamente llamadas de riesgo en su dispositivo.
                {blockingEnabled ? ' Las llamadas de alto riesgo serán bloqueadas.' : ''}
              </Text>
            </View>
          </View>
        </View>
        ...
        <View style={styles.callsContainer}>
          <Text style={styles.sectionTitle}>Historial de Llamadas Sospechosas</Text>
